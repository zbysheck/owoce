<div class="main container">
    ...
    <div class="ui active tab" data-tab="definition"><div class="ui close right rail" style="height: 1338px;"><div class="ui sticky" style="width: 200px; height: 188px;"><div class="ui secondary vertical following fluid accordion menu"><div class="item"><a class="active title"><i class="dropdown icon"></i> <b>Types</b></a><div class="active content menu"><a class="item" href="#accordion">Accordion</a><a class="item" href="#styled">Styled</a></div></div><div class="item"><a class="title"><i class="dropdown icon"></i> <b>Variations</b></a><div class="content menu"><a class="item" href="#fluid">Fluid</a><a class="item" href="#inverted">Inverted</a></div></div></div></div></div>

        <h2 class="ui dividing header">Types<a class="anchor" id="types"></a></h2>
        <div class="example">
            <h4 class="ui header">Accordion</h4><i class="icon code"></i><a class="anchor" id="accordion"></a>
        ...
        <div class="example">
            <h4 class="ui header">Styled</h4><i class="icon code"></i><a class="anchor" id="styled"></a>
        ...
        <div class="example">
            <h4 class="ui header">Fluid</h4><i class="icon code"></i><a class="anchor" id="fluid"></a>
        ...
        <div class="example">
            <h4 class="ui header">Inverted</h4><i class="icon code"></i><a class="anchor" id="inverted"></a>
    ...
    <div class="ui tab" data-tab="examples">
        ...
        <h2 class="ui dividing header">Examples<a class="anchor" id="examples"></a></h2>

        <div class="example">
            <h4 class="ui header">Nested</h4><i class="icon code"></i><a class="anchor" id="nested"></a>
        ...
        <div class="example">
            <h4 class="ui header">Form</h4><i class="icon code"></i><a class="anchor" id="form"></a>
        ...
        <div class="example">
            <h4 class="ui header">Menu</h4><i class="icon code"></i><a class="anchor" id="menu"></a>
    ...
    <div class="ui tab" data-tab="usage">
        ...
        <h2 class="ui dividing header">Initializing<a class="anchor" id="initializing"></a></h2>

        <div class="no example">
            <h4 class="ui header">Initializing an accordion</h4><i class="icon code"></i><a class="anchor" id="initializing-an-accordion"></a>
        ...
        <div class="no example">
            <h4 class="ui header">AJAX Content</h4><i class="icon code"></i><a class="anchor" id="ajax-content"></a>
            ...
            </p><div class="code" data-type="javascript">
                $('.ui.accordion').accordion('refresh');
            </div>
        </div>

        <h2 class="ui dividing header">Behaviors<a class="anchor" id="behaviors"></a></h2>

        <p>Behaviors are short english phrases used for accessing specific functionality in

        </p><p>Behaviors are accessible with javascript using the syntax:</p><p>
        </p><div class="code">
